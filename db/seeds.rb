...
Hero.create!(
  ...
  second_power_name: "Die Hard",
  second_power_color: "Yellow",
  second_power_cost: "PASSIVE",
  second_power_description: "Logan's healing factor keeps him standing, but ain't quite what it used to be. At the start of the turn, Wolverine restores 273 health to himself for each other team member still in the fight.",
  second_power_name_alt: "Old Habits",
  second_power_color_alt: "Yellow",
  second_power_cost_alt: "6",
  second_power_description_alt: "Wolverine takes on all his enemies at once, his berserker rage fueled by the choas of the brawl. Wolverine deals 511 damage to the enemy team, plus an additional 248 damage for each enemy in the fight.",
